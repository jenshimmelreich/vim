...
" Version:      0.1
" Eine ia_writer-Varianate von mac_classic
...
let g:colors_name = "ia_writer"


" Colors: {{{1
" TODO figure out how to not highlight TODO
"
" #1A1A1A - Vordergrund: war #000000
" #00C1FF - BLUE/GREY - cursor, rails helpers war #3C4C72
...
" #F7F7F7 - Hintergrund: WHITE war: #FFFFFF
" }}}

" GUI: {{{1
hi Cursor  guifg=#F7F7F7 ctermfg=15 guibg=#00C1FF ctermbg=240
...
hi VertSplit  guifg=#F7F7F7 ctermfg=15 guibg=#CFCFCF ctermbg=252 gui=NONE
...
hi Folded  guifg=#0066FF ctermfg=27 guibg=#F7F7F7 ctermbg=15
" StatusLine: {{{2
hi StatusLine  guifg=#1A1A1A ctermfg=0 guibg=#C6DEFF ctermbg=189 gui=italic
hi StatusLineNC  guifg=#1A1A1A ctermfg=0 guibg=#EFEFEF ctermbg=7 gui=NONE
...
" Syntax: {{{1
hi Normal  guifg=#1A1A1A ctermfg=0 guibg=#F7F7F7 ctermbg=15
...
hi ErrorMsg  guifg=#F7F7F7 ctermfg=15 guibg=#990000 ctermbg=88
hi WarningMsg  guifg=#F7F7F7 ctermfg=15 guibg=#990000 ctermbg=88
...
hi Special  guifg=#1A1A1A ctermfg=0
...
hi Title  guifg=#1A1A1A ctermfg=0 gui=bold
hi Todo  guifg=#0066FF ctermfg=27 gui=inverse,bold,italic
hi Underlined  gui=underline

" Invisible character colors
hi NonText  guifg=#DFDFDF ctermfg=253 guibg=#F7F7F7 ctermbg=15
hi SpecialKey  guifg=#DFDFDF ctermfg=253 guibg=#F7F7F7 ctermbg=15

" Diff styles {{{1
hi diffAdded guifg=#007B22 guibg=#F7F7F7 ctermfg=28 ctermbg=15
hi diffRemoved guifg=#D51015 guibg=#F7F7F7 ctermfg=160 ctermbg=15
hi diffFile guifg=#6E79F1 guibg=#F7F7F7 ctermfg=69 ctermbg=15
hi diffNewFile guifg=#6E79F1 guibg=#F7F7F7 ctermfg=69 ctermbg=15
hi diffLine guifg=#1A1A1A guibg=#F7F7F7 ctermfg=0 ctermbg=15

hi diffAdd guifg=#007B22 guibg=#F7F7F7 ctermfg=28 ctermbg=15
hi diffChange guifg=#007B22 guibg=#F7F7F7 ctermfg=28 ctermbg=15
hi diffText guifg=#007B22 guibg=#F7F7F7 ctermfg=28 ctermbg=15
hi link diffDelete diffRemoved
" Git styles {{{1
hi gitcommitFirstLine guifg=#1A1A1A guibg=#F7F7F7 ctermfg=0 ctermbg=15
hi gitcommitSelectedType guifg=#007B22 guibg=#F7F7F7 ctermfg=28 ctermbg=15
hi link gitcommitSelectedFile gitcommitSelectedType
hi gitcommitDiscardedType guifg=#D51015 guibg=#F7F7F7 ctermfg=160 ctermbg=15
hi link gitcommitDiscardedFile gitcommitDiscardedType
hi gitcommitUntrackedFile guifg=#6E79F1 guibg=#F7F7F7 ctermfg=69 ctermbg=15
" Ruby styles {{{1
...
hi rubyRailsARAssociationMethod  guifg=#00C1FF ctermfg=240 gui=bold
hi rubyRailsARMethod  guifg=#00C1FF ctermfg=240 gui=bold
hi rubyRailsRenderMethod  guifg=#00C1FF ctermfg=240 gui=bold
hi rubyRailsMethod  guifg=#00C1FF ctermfg=240 gui=bold
hi link erubyComment Comment
hi erubyRailsMethod  guifg=#00C1FF ctermfg=240 gui=bold
...
hi javaScriptRailsFunction  guifg=#00C1FF ctermfg=240 gui=bold
...
hi cssFunctionName  guifg=#00C1FF ctermfg=240 gui=bold
...
hi vimCommentTitle  guifg=#00C1FF ctermfg=240 gui=bold
...
hi OL1 guifg=#1A1A1A ctermfg=0 gui=bold
